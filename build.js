...
const UI = {
  ...
  es: {
    ...
    disclaimer: 'Traducción del inglés escrita por el asistente, sin revisión humana; la página en inglés es la versión de referencia.',
  },
  pt: {
    ...
    disclaimer: 'Tradução do inglês escrita pelo assistente, sem revisão humana; a página em inglês é a versão de referência.',
  },
};
