...
const PUBLISHER_BRACKET_OK = new Set([
  // 'The Miracle Hunter (Michael O’Neill)' — the bracket NAMES the site's
  // author, which is bibliography, not a characterisation of the source.
  'miraclehunter-ratisbonne',
]);
// <<< ADOPT
